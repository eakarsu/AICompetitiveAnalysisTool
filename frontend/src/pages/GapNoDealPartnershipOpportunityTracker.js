...
/**
 * Gap/CFS Feature Page: No deal/partnership opportunity tracker.
 * Slug: no-deal-partnership-opportunity-tracker
 * Backend: /api/gap-no-deal-partnership-opportunity-tracker
 */
export default function NoDealPartnershipOpportunityTrackerPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-deal-partnership-opportunity-tracker', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No deal/partnership opportunity tracker.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No deal/partnership opportunity tracker.</p>
