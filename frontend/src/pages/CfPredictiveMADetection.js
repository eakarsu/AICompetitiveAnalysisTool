...
/**
 * Gap/CFS Feature Page: Predictive M&A detection
 * Slug: predictive-m-a-detection
 * Backend: /api/cf-predictive-m-a-detection
 */
export default function PredictiveMADetectionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-m-a-detection', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive M&A detection</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Flag acquisition targets/acquirers based on financial, talent, and tech signals.</p>
