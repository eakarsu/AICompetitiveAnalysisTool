...
/**
 * Gap/CFS Feature Page: No playbook/strategy library.
 * Slug: no-playbook-strategy-library
 * Backend: /api/gap-no-playbook-strategy-library
 */
export default function NoPlaybookStrategyLibraryPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-playbook-strategy-library', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No playbook/strategy library.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No playbook/strategy library.</p>
