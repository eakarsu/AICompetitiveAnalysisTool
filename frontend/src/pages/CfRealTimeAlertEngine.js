...
/**
 * Gap/CFS Feature Page: Real-time alert engine
 * Slug: real-time-alert-engine
 * Backend: /api/cf-real-time-alert-engine
 */
export default function RealTimeAlertEnginePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-real-time-alert-engine', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Real-time alert engine</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Email alerts on competitor announcements, job listings, funding rounds.</p>
