...
/**
 * Gap/CFS Feature Page: No pricing-database or pricing-intelligence module.
 * Slug: no-pricing-database-or-pricing-intelligence-module
 * Backend: /api/gap-no-pricing-database-or-pricing-intelligence-module
 */
export default function NoPricingDatabaseOrPricingIntelligenceModulePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-pricing-database-or-pricing-intelligence-module', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No pricing-database or pricing-intelligence module.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No pricing-database or pricing-intelligence module.</p>
