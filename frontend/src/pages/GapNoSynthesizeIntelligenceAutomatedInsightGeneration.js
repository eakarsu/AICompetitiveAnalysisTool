...
/**
 * Gap/CFS Feature Page: No `/synthesize-intelligence` automated-insight generation.
 * Slug: no-synthesize-intelligence-automated-insight-generation
 * Backend: /api/gap-no-synthesize-intelligence-automated-insight-generation
 */
export default function NoSynthesizeIntelligenceAutomatedInsightGenerationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-synthesize-intelligence-automated-insight-generation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No `/synthesize-intelligence` automated-insight generation.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No `/synthesize-intelligence` automated-insight generation.</p>
