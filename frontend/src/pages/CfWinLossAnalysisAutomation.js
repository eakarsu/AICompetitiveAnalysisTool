...
/**
 * Gap/CFS Feature Page: Win/loss analysis automation
 * Slug: win-loss-analysis-automation
 * Backend: /api/cf-win-loss-analysis-automation
 */
export default function WinLossAnalysisAutomationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-win-loss-analysis-automation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Win/loss analysis automation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Ingest CRM data; highlight why customers chose competitors using semantic analysis.</p>
