...
/**
 * Gap/CFS Feature Page: AI competitive positioning dashboard
 * Slug: ai-competitive-positioning-dashboard
 * Backend: /api/cf-ai-competitive-positioning-dashboard
 */
export default function AiCompetitivePositioningDashboardPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-ai-competitive-positioning-dashboard', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>AI competitive positioning dashboard</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Parse competitor websites, earnings calls, job postings; synthesize insights monthly.</p>
