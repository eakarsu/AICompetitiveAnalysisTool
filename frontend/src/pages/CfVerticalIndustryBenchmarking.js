...
/**
 * Gap/CFS Feature Page: Vertical industry benchmarking
 * Slug: vertical-industry-benchmarking
 * Backend: /api/cf-vertical-industry-benchmarking
 */
export default function VerticalIndustryBenchmarkingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-vertical-industry-benchmarking', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Vertical industry benchmarking</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Compare product/pricing/features within specific niches (SaaS, FinTech, HealthTech).</p>
