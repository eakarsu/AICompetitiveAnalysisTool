...
/**
 * Gap/CFS Feature Page: No SMS or payment integration.
 * Slug: no-sms-or-payment-integration
 * Backend: /api/gap-no-sms-or-payment-integration
 */
export default function NoSmsOrPaymentIntegrationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-sms-or-payment-integration', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No SMS or payment integration.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No SMS or payment integration.</p>
